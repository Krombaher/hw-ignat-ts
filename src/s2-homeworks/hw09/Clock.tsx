...
function Clock() {
    ...
    const stringDate = `${('0' + date.getDate()).slice(-2)}.${date.getMonth() + 1}.${date.getFullYear()}` // день.месяц.год (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
